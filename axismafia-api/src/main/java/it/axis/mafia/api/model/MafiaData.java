...
public class MafiaData {
    ...
    public Map<UUID, MafiaRank> getMembers() {
        return members;
    }

    public void setMembers(Map<UUID, MafiaRank> members) {
        this.members = members;
    }

    public Map<String, Boolean> getUnlockedKits() {
        return unlockedKits;
    }

    public void setUnlockedKits(Map<String, Boolean> unlockedKits) {
